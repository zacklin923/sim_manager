...
<div id="hint" style="position: fixed;top: 50%;left: 50%;width: 400px;height: 30px;margin-left: -200px;margin-top: -15px;text-align: center;display:none;color: white;font-size: 20px;font-weight: bold;background-color: black;line-height: 30px;z-index: 10000;">		
